...
def download_pretrained_model():
    ...
    if not os.path.isfile('FashionMNIST_plain.pt'):
        if not os.path.exists('./temp'):
            os.makedirs('./temp')

        urllib.request.urlretrieve('https://nc.mlcloud.uni-tuebingen.de/index.php/s/2PBDYDsiotN76mq/download', './temp/FashionMNIST_plain.pt')
